...
$imagem 			= str_replace('.php', '.webp', $urlPagina); //imagem das páginas das palavras-chave
$imagem2 			= str_replace('.php', '-2.webp', $urlPagina); //imagem das páginas das palavras-chave
$imagem3 			= str_replace('.php', '-3.webp', $urlPagina); //imagem das páginas das palavras-chave
$bannerTopo 		= str_replace('.webp', '', $imagem);
