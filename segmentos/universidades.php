		...
		<div class="row justify-content-center">
			...
			<div class="col-md-5 offset-lg-1">
				<div class="owl-carousel owl-theme nav-bottom mb-0" data-plugin-options="{'items': 1, 'margin': 10, 'animateOut': 'fadeOut', 'autoplay': true,'dots': false, 'loop': true, 'nav': true}">
					<div>
						<a class="lightbox" href="<?= $urlcompleta; ?>img/segmentos/universidades-1-1.jpg" data-plugin-options="{'type':'image'}">
							<img class="img-fluid" src="<?= $urlcompleta; ?>img/segmentos/universidades-1.jpg" alt="<?=$title;?>">
						</a>
					</div>
					<div>
						<a class="lightbox" href="<?= $urlcompleta; ?>img/segmentos/universidades-2-1.jpg" data-plugin-options="{'type':'image'}">
							<img class="img-fluid" src="<?= $urlcompleta; ?>img/segmentos/universidades-2.jpg" alt="<?=$title;?>">
						</a>
					</div>
				</div>
			</div>
