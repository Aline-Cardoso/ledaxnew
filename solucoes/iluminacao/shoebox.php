			...
			<div class="row align-items-center justify-content-center">
					...
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<picture><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/shoebox-39w-59w.webp" type="image/webp"><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/shoebox-39w-59w.jpg" type="image/jpg"><img src="<?=$urlcompleta;?>img/solucoes/produtos/shoebox-39w-59w.jpg" class="img-fluid" alt="Shoebox 39W/59W"/></picture>
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<picture><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/shoebox-74w-113w.webp" type="image/webp"><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/shoebox-74w-113w.jpg" type="image/jpg"><img src="<?=$urlcompleta;?>img/solucoes/produtos/shoebox-74w-113w.jpg" class="img-fluid" alt="Shoebox 74W/113W"/></picture>
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
