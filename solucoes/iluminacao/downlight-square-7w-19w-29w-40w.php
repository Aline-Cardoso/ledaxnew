...
$title = 'Downlight Square 7W/19W/29W/40W';
			...
			<div class="row">
				<div class="col-md-5 mb-2 mb-md-0">
					...
					<div class="thumb-gallery-wrapper">
						<div class="thumb-gallery-detail owl-carousel owl-theme manual nav-inside nav-style-1 nav-dark mb-3">
							<div>
								<img alt="<?=$title;?>" class="img-fluid" src="<?=$urlcompleta;?>img/solucoes/produtos/downlight-square-7w-19w-29w-40w.jpg">
							</div>
						</div>
					</div>
				...
				<div class="col-md-7">
					...
					<div class="summary entry-summary position-relative">
							...
							<tbody>
								<tr>
									...
									<td class="border-top-0">
										957 lm / 2.388 lm / 3.582 lm / 4.987 lm
									</td>
								</tr>
								<tr>
									<th>
								...
								<tr>
									...
									<td>
										175x175x102mm / 225x225x102mm / 400x400x102mm / 618x618x102mm
									</td>
								</tr>
								<tr>
									<th>
						...
						<a href="<?=$urlcompleta;?>img/solucoes/produtos/desenho-tecnico/downlight-square-7w-19w-29w-40w.png" target="_blank" class="btn btn-dark btn-modern text-uppercase bg-color-hover-primary border-color-hover-primary"><i class="fas fa-image"></i> Desenho Técnico</a>
