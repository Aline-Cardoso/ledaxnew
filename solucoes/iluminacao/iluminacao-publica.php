			...
			<div class="row align-items-center justify-content-center">
					...
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<picture><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/tate.webp" type="image/webp"><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/tate.jpg" type="image/jpg"><img src="<?=$urlcompleta;?>img/solucoes/produtos/tate.jpg" class="img-fluid" alt="Tate"/></picture>
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<picture><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/atmosfera.webp" type="image/webp"><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/atmosfera.jpg" type="image/jpg"><img src="<?=$urlcompleta;?>img/solucoes/produtos/atmosfera.jpg" class="img-fluid" alt="Atmosfera"/></picture>
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<picture><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/street-centauris.webp" type="image/webp"><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/street-centauris.jpg" type="image/jpg"><img src="<?=$urlcompleta;?>img/solucoes/produtos/street-centauris.jpg" class="img-fluid" alt="Street Centauris"/></picture>
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<picture><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/island.webp" type="image/webp"><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/island.jpg" type="image/jpg"><img src="<?=$urlcompleta;?>img/solucoes/produtos/island.jpg" class="img-fluid" alt="Island"/></picture>
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<picture><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/shoebox.webp" type="image/webp"><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/shoebox.jpg" type="image/jpg"><img src="<?=$urlcompleta;?>img/solucoes/produtos/shoebox.jpg" class="img-fluid" alt="Shoebox"/></picture>
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
				...
				<div class="col-lg-3">
					<div class="py-3">
						<span class="thumb-personalizada thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
							<span class="thumb-info-wrapper">
								<picture><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/street-polaris.webp" type="image/webp"><source srcset="<?=$urlcompleta;?>img/solucoes/produtos/street-polaris.jpg" type="image/jpg"><img src="<?=$urlcompleta;?>img/solucoes/produtos/street-polaris.jpg" class="img-fluid" alt="Street Polaris"/></picture>
								<span class="thumb-info-title">
									<span class="thumb-info-slide-info-hover-1">
