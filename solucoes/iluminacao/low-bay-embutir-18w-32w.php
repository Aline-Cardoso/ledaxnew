			...
			<div class="row">
				<div class="col-md-5 mb-2 mb-md-0">
					...
					<div class="thumb-gallery-wrapper">
						<div class="thumb-gallery-detail owl-carousel owl-theme manual nav-inside nav-style-1 nav-dark mb-3">
							<div>
								<img alt="<?=$title;?>" class="img-fluid" src="<?=$urlcompleta;?>img/solucoes/produtos/low-bay-embutir-18w-32w.jpg">
							</div>
						</div>
					</div>
				...
				<div class="col-md-7">
					...
					<div class="summary entry-summary position-relative">
						...
						<a href="<?=$urlcompleta;?>img/solucoes/produtos/desenho-tecnico/low-bay-embutir-18w-32w.png" target="_blank" class="btn btn-dark btn-modern text-uppercase bg-color-hover-primary border-color-hover-primary"><i class="fas fa-image"></i> Desenho Técnico</a>
